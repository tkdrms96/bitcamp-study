                ...
                <div class="col-md-12">
                        ...
                        <form id="form1">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nbno_id" class="form-control" id="exampleInputEmail10" value="<c:out value="${noticeBoardDTO.nbno_id}"></c:out>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">제목</label>
                                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" value="<c:out value="${noticeBoardDTO.title}"></c:out>" ></div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label>내용</label>
                                            <textarea name="description" class="form-control" rows="15" ><c:out value="${noticeBoardDTO.description}"></c:out></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <c:if test="${noticeBoardDTO.files[0].nano_id != null}">
                        <c:forEach items="${noticeBoardDTO.files}" var="attach">
                            <div data-nano_id="${attach.nano_id}"
                                ...
                                <c:if test="${attach.image}">
                                    <img src="/noticeboard/viewFile?file=${attach.img_thumbnail_name}">
                                </c:if>
...
<script>
    ...
    document.querySelector(".btnMod").addEventListener("click", (e) => {
        ...
        form.setAttribute("action","/noticeboard/modify")
